...
* [x] Using SwipeRefreshLayout to enable swipe down to refresh feature
* [x] Leveraged the onFailure in network request client to move on to the next page while infinite loading of pages
...
Implemetation of Recycler views along with error handling of network requests
